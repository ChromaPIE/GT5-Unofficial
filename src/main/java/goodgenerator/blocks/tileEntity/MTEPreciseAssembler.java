...
public class MTEPreciseAssembler extends MTEExtendedPowerMultiBlockBase<MTEPreciseAssembler>
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType("machtype.assembler", "machtype.prass.long", "machtype.prass")
            .addInfo("gt.mb.prass.desc.1")
            .addTecTechHatchInfo()
            .addPollutionAmount(getPollutionPerSecond(null))
            .beginStructureBlock(9, 5, 5, true)
            .addController("fbm")
            .addCasingInfoExactly("gt.blockcasings.name", 21, true)
            .addCasingInfoExactly("GT5U.MBTT.AnyGlass", 42, 4)
            .addCasingInfoRange("preciseUnitCasing.name", 42, 86, true)
            .addInputHatch("GT5U.MBTT.AnyCasing")
            .addInputBus("GT5U.MBTT.AnyCasing")
            .addOutputHatch("GT5U.MBTT.AnyCasing")
            .addOutputBus("GT5U.MBTT.AnyCasing")
            .addEnergyHatch("GT5U.MBTT.AnyCasing")
            .addMufflerHatch("GT5U.MBTT.AnyCasing")
            .addMaintenanceHatch("GT5U.MBTT.AnyCasing")
            .addSubChannelUsage("glass", "channelpurpose.glass_tier")
            .addSubChannelUsage("unit_casing", "channelpurpose.peuc_tier")
            .addSubChannelUsage("machine_casing", "channelpurpose.casing_tier")
            .toolTipFinisher();
        return tt;
    }
